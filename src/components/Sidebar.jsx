    ...
    <aside
      className={[
        ...
        drawer
          ...
          : "max-h-[48vh] rounded-none sm:rounded-xl lg:h-[calc(100vh-2rem)] lg:max-h-none",
      ].join(" ")}
    >
      <div className="border-b border-white/10 p-3">
        <div className="flex items-center gap-2.5">
          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-[#38d6c6] text-slate-950">
            <Compass size={18} strokeWidth={2.4} />
          </div>
          <div className="min-w-0">
            <p className="text-[0.82rem] font-semibold uppercase text-[#92a5a0]">
              Travel AI
            </p>
            <h1 className="truncate text-base font-semibold">Travel Planner</h1>
          </div>
        </div>
        ...
        <button
          type="button"
          onClick={onNewChat}
          className="mt-3 flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-white text-sm font-semibold text-slate-950 transition hover:bg-[#38d6c6] focus:outline-none focus:ring-2 focus:ring-[#38d6c6] focus:ring-offset-2 focus:ring-offset-[#101820]"
        >
          <Plus size={18} />
          <span>New chat</span>
        </button>
      ...
      <nav className="planner-scrollbar min-h-0 flex-1 overflow-y-auto p-3">
        <section>
          <div className="mb-2 flex items-center gap-2 text-[0.82rem] font-semibold uppercase text-[#92a5a0]">
          ...
          <div className="space-y-2">
            {savedTrips.length ? (
              savedTrips.slice(0, 12).map((trip) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="mt-1 block text-[0.86rem] text-[#aebfba]">
              ...
              <p className="rounded-lg border border-white/10 bg-white/5 p-3 text-[0.86rem] leading-6 text-[#7f918c]">
