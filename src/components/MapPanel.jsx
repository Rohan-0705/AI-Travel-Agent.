  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-5">
        <div className="h-64 overflow-hidden rounded-lg border border-slate-200 bg-slate-100 sm:h-80 2xl:h-96">
          <iframe
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          ...
          <div className="rounded-lg border border-slate-200 bg-[#fff9ed] p-3">
            <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <div className="rounded-lg border border-slate-200 bg-[#fff6f3] p-3">
            <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <div className="rounded-lg border border-slate-200 bg-[#eef4ff] p-3">
            <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
      ...
      <section className="border-t border-slate-200 p-3 sm:p-5">
        <div className="flex items-center justify-between gap-3">
          ...
          <Navigation size={19} className="text-[#0f8f83]" />
        </div>
        ...
        <ol className="mt-4 space-y-3">
          {route.map((stop, index) => (
            <li key={stop} className="flex items-start gap-3">
              ...
              <span className="min-w-0 flex-1 text-[0.98rem] font-medium leading-7 text-slate-700">
                {stop}
              </span>
            </li>
          ))}
      ...
      <section className="border-t border-slate-200 p-3 sm:p-5">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-slate-950">Smart checks</h3>
        </div>
        <div className="mt-4 grid gap-2">
      ...
      <section className="border-t border-slate-200 p-3 sm:p-5">
        <h3 className="text-lg font-semibold text-slate-950">Stay shortlist</h3>
        <div className="mt-4 space-y-2">
          {stays.map((stay) => (
            <div
              key={stay.name}
              className="rounded-lg border border-slate-200 bg-[#fbfdfb] p-3"
            >
